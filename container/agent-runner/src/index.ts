  ...
  try {
    for await (const message of query({
      ...
      options: {
        ...
        hooks: {
          PreCompact: [{ hooks: [createPreCompactHook('/workspace/group', containerInput.assistantName, log)] }],
          PreToolUse: [
...
async function main(): Promise<void> {
  ...
  const activityPoster = new ActivityPoster(
    secrets.GALLERY_CONVEX_URL || null,
    secrets.GALLERY_GATEWAY_TOKEN || null,
